...
class SeatTypeSeeder extends Seeder
{
    public function run()
    {
        ...
        $seatTypes = [
            ['seat_type_id' => 'STD', 'seat_type_name' => 'Standard', 'seat_type_price' => 0],
            ['seat_type_id' => 'GLD', 'seat_type_name' => 'Gold', 'seat_type_price' => 5],
            ['seat_type_id' => 'PLT', 'seat_type_name' => 'Platinum', 'seat_type_price' => 10],
            ['seat_type_id' => 'BOX', 'seat_type_name' => 'Box (Couple)', 'seat_type_price' => 6],
        ];
